...
export const background = styleMap(({ color }) => ({
  ...
  formAccentActive: {
    background: getActiveColor(color.background.formAccent),
  },
  formAccentHover: {
    background: getHoverColor(color.background.formAccent),
  },
  brandAccentActive: {
    background: getActiveColor(color.background.brandAccent),
  },
  brandAccentHover: {
    background: getHoverColor(color.background.brandAccent),
  },
  infoLight: { background: getLightVariant(color.background.info) },
  criticalLight: {
    background: getLightVariant(color.background.critical),
  },
  positiveLight: {
    background: getLightVariant(color.background.positive),
  },
}));
